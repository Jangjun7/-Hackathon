...
public class high_1_activity extends AppCompatActivity {
    Button answer;
    ImageButton home_btn, back_btn;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.high_1_layout);
    ...
    public void OnClick_high_1_wrong(View view)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogTheme);

        builder.setMessage("고_설명서_1");
    ...
    public void OnClick_high_1_answer(View view)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogTheme);
        ...
        builder.setPositiveButton("다음 문제", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int id)
            {
                Intent intent = new Intent(getApplicationContext(), high_2_activity.class);
                startActivity(intent);
            }
        });
