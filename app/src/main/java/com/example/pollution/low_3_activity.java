...
public class low_3_activity extends AppCompatActivity {
    Button answer;
    ImageButton home_btn, back_btn;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.low_3_layout);
    ...
    public void OnClick_low_3_wrong(View view)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogTheme);

        builder.setMessage("초_설명서_3");
    ...
    public void OnClick_low_3_answer(View view)
    {

        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogTheme);

        builder.setMessage("당신은 초보(하) 난이도에 모든 스테이지를 클리어하였습니다!\n다음 난이도에 도전하세요!");
