...
public class high_2_activity extends AppCompatActivity {
    Button answer;
    ImageButton home_btn, back_btn;
    @Override
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.high_2_layout);
    ...
    public void OnClick_high_2_wrong(View view)
    {
        AlertDialog.Builder builder = new AlertDialog.Builder(this, R.style.AlertDialogTheme);

        builder.setMessage("고_설명서_2");
    ...
    public void OnClick_high_2_answer(View view)
    {
        ...
        builder.setPositiveButton("다음 문제", new DialogInterface.OnClickListener(){
            ...
            public void onClick(DialogInterface dialog, int id)
            {
                Intent intent = new Intent(getApplicationContext(), high_3_activity.class);
                startActivity(intent);
            }
        });
